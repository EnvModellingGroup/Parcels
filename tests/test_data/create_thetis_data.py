...
# based on https://github.com/thetisproject/thetis/blob/master/test/swe2d/test_steady_state_channel.py

lx = 5e3
ly = 1e3
# we don't expect converge as the reference solution neglects the advection term
mesh2d = RectangleMesh(25, 5, lx, ly)
...
solver_obj.options.output_directory = "output"
solver_obj.options.fields_to_export = []
solver_obj.options.fields_to_export_hdf5 = ['uv_2d', 'elev_2d']
